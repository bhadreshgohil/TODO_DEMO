...
import 'package:todo_app/custom_component/image_custom_view.dart';
import 'package:todo_app/theme/custom_text_style.dart';

import 'app/todo_products/pages/products_list.dart';
import 'blocs.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        Blocs.blocs.todoBloc,
        Blocs.blocs.databaseBloc,
      ],
      child: MaterialApp(
        title: 'Flutter Demo',
        theme: ThemeData(
